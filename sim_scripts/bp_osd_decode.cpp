...
int main(int argc, char *argv[])
{
    ...
    int min_interations_before_converge=hx_n;
...
//            osdw_decoding = hx_bp_osd.osd0_decoding;
            ...
            if (*hx_bp_osd.converge == 1) {
                ...
                if (*hx_bp_osd.iter<min_interations_before_converge){
                    min_interations_before_converge=*hx_bp_osd.iter+1;
                }
        ...
        if((time.elapsed_time_seconds()-elapsed_seconds>3) | (run_count==target_runs) ){
            ...
            output["min_iterations_before_converge"]=min_interations_before_converge;
